...
# Start the app
CMD sleep 3 && /rogueserver -debug=$IS_DEBUG -proto=$PROTOCOL -addr=$ADDRESS -dbuser=$MYSQL_DB_USERNAME -dbpass=$MYSQL_DB_PASSWORD -dbproto=$MYSQL_DB_PROTOCOL -dbaddr=$MYSQL_DB_ADDRESS -dbname=$MYSQL_DB_NAME -allowedorigins=$CORS_ALLOWED_ORIGINS